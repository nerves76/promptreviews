 ...
 *
 * This script:
 * 1. Creates CMS articles via the admin API
 * 2. Reports conversion results
 *
 * Usage: SUPABASE_SERVICE_ROLE_KEY=xxx node scripts/convert-features-to-cms.js
 */
...
const featuresData = [
  {
    ...
    canonical_url: 'https://docs.promptreviews.app/prompt-pages/features/analytics',
  ...
  },
  {
    ...
    category_color: 'pink',
    canonical_url: 'https://docs.promptreviews.app/prompt-pages/features/customization',
    available_plans: ['grower', 'builder', 'maven'],
    key_features: [
      {
        icon: 'Palette',
  ...
  },
  {
    ...
    seo_title: 'Emoji Feedback Flow - Interactive Review Collection',
    seo_description: 'Learn how Emoji Feedback Flow makes review collection fun and engaging with interactive emoji reactions that guide customers to appropriate review platforms.',
    keywords: ['emoji sentiment', 'interactive reviews', 'customer feedback', 'emoji reactions'],
    category_label: 'Features',
    category_icon: 'Smile',
    category_color: 'orange',
    canonical_url: 'https://docs.promptreviews.app/prompt-pages/features/emoji-sentiment',
    available_plans: ['grower', 'builder', 'maven'],
    key_features: [
      {
        icon: 'Heart',
  ...
  },
  {
    ...
    canonical_url: 'https://docs.promptreviews.app/prompt-pages/features/integration',
    available_plans: ['grower', 'builder', 'maven'],
    key_features: [
      {
        icon: 'MapPin',
  ...
  },
  {
    ...
    category_color: 'cyan',
    canonical_url: 'https://docs.promptreviews.app/prompt-pages/features/mobile',
    available_plans: ['grower', 'builder', 'maven'],
    key_features: [
      {
        icon: 'Eye',
  ...
  },
  {
    ...
    category_color: 'blue',
    canonical_url: 'https://docs.promptreviews.app/prompt-pages/features/multi-platform',
    available_plans: ['grower', 'builder', 'maven'],
    key_features: [
      {
        icon: 'Link2',
  ...
  },
  {
    ...
    category_color: 'blue',
    canonical_url: 'https://docs.promptreviews.app/prompt-pages/features/qr-codes',
    available_plans: ['grower', 'builder', 'maven'],
    key_features: [
      {
        icon: 'CreditCard',
  ...
  },
  {
    ...
    canonical_url: 'https://docs.promptreviews.app/prompt-pages/features/security',
    available_plans: ['grower', 'builder', 'maven'],
    key_features: [
      {
        icon: 'Lock',
...
console.log('Feature pages data prepared.');
console.log(`Total features to convert: ${featuresData.length}`);
console.log('\nFeature slugs:');
featuresData.forEach(f => console.log(`  - ${f.slug}`));

console.log('\nTo create these articles in the CMS, you need to:');
console.log('1. Start the dev server: npm run dev');
console.log('2. Use the Supabase Admin panel or run a migration to insert these articles');
console.log('3. Or manually POST each article to the /api/admin/help-content endpoint');
console.log('\nData is ready in this script file.');
