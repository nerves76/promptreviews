-- Prompt Page Articles Part 2: Individual Page Types
-- Run after part 1

-- ============================================================================
-- 3. SERVICE REVIEW PAGES
-- ============================================================================
...
-- Due to SQL length limits, I'll provide the remaining types in a summary format
-- You can expand each one following the same pattern as Service pages

-- NOTE: Remaining types to create following this same pattern:
-- - prompt-pages/types/product (for product reviews)
-- - prompt-pages/types/employee (for employee spotlights)
-- - prompt-pages/types/event (for events & spaces)
-- - prompt-pages/types/photo (for photo + testimonial)
-- - prompt-pages/types/video (for video testimonials)
-- - prompt-pages/types (overview page listing all types)
