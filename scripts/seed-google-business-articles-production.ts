/**
 * Script to seed Google Business Profile documentation articles to PRODUCTION
 * Run with: npx ts-node --esm scripts/seed-google-business-articles-production.ts
 *
 * WARNING: This script writes to the PRODUCTION database!
 */
...
// Safety check - ensure we're pointing to production
if (!supabaseUrl.includes('ltneloufqjktdplodvao.supabase.co')) {
  console.error('ERROR: Not connected to production Supabase instance!');
  console.error('Current URL:', supabaseUrl);
  process.exit(1);
}

console.log('🚨 WARNING: You are about to seed articles to PRODUCTION database!');
...
async function seedArticles() {
  console.log('🚀 Starting to seed Google Business Profile articles to PRODUCTION...\n');
