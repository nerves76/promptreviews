  ...
  return (
    <div className="min-h-screen flex justify-center items-start px-4 sm:px-0">
      ...
      <WelcomePopup
        ...
        message={"Welcome to Prompt Reviews!\n\nDid you know you're a star? Carl Sagan said it best:\n\n\"The cosmos is within us. We are made of star-stuff. We are a way for the universe to know itself.\"\n\nBeautiful right! There is a flaming gas giant in you too! Wait, that didn't come out right . . . Anyway, I am here to help you get the stars you deserve—on Google, Facebook, TripAdvisor, TrustPilot—you name it.\n\nHere's your first tip: [icon] <----Click here"}
