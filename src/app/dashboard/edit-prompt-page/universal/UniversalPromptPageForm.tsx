...
import ReviewPlatformsSection, { ReviewPlatformLink } from '../components/ReviewPlatformsSection';
...
const UniversalPromptPageForm = forwardRef<any, UniversalPromptPageFormProps>(
  ({ onSave, isLoading, initialData, showResetButton, businessReviewPlatforms = [] }, ref) => {
    ...
    const [reviewPlatforms, setReviewPlatforms] = useState<ReviewPlatformLink[]>(initialData?.reviewPlatforms ?? []);
      ...
      <form className="space-y-8" onSubmit={e => {
        ...
        <div className="mt-16">
          <ReviewPlatformsSection
            ...
            onResetToDefaults={showResetButton ? () => setReviewPlatforms(businessReviewPlatforms) : undefined}
          />
        </div>
