  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <p className="mb-4 text-gray-700">
        Your privacy is important to Prompt Reviews. This Privacy Policy
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        <li>
          Account information (name, email, business details) you provide when
          signing up.
        </li>
        <li>
          Content you submit, such as reviews, testimonials, and business
          information.
        </li>
        <li>
          Usage data, such as page views, device information, and IP address.
        </li>
      </ul>
      <h2 className="text-xl font-semibold mt-8 mb-2">
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        ...
        <li>
          To communicate with you about your account or updates to the platform.
        </li>
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        ...
        <li>
          ...
          the platform (e.g., hosting, analytics, payment processing).
        </li>
        <li>
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        ...
        <li>
          No system is 100% secure; please use strong passwords and protect your
          account.
        </li>
      </ul>
      ...
      <ul className="list-disc ml-6 mb-4 text-gray-700">
        <li>
          ...
          you of significant changes, but please review this page periodically.
        </li>
      </ul>
