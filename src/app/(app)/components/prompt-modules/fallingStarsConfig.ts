...
export const loadAllFallingIcons = async (): Promise<{
  ...
  return [
    ...
    { key: "dollarsign", label: "Dollar Sign", icon: FaDollarSign, color: "text-green-600", category: "Small Business" },
    { key: "moneybill", label: "Money", icon: FaMoneyBillWave, color: "text-green-500", category: "Small Business" },
    { key: "coins", label: "Coins", icon: FaCoins, color: "text-yellow-500", category: "Small Business" },
    { key: "cashregister", label: "Cash Register", icon: FaCashRegister, color: "text-gray-600", category: "Small Business" },
    { key: "stethoscope", label: "Stethoscope", icon: FaStethoscope, color: "text-red-500", category: "Small Business" },
    { key: "broom", label: "Broom", icon: FaBroom, color: "text-amber-700", category: "Small Business" },
    ...
    { key: "hammer", label: "Hammer", icon: FaHammer, color: "text-amber-700", category: "Tools & Objects" },
    { key: "cut", label: "Scissors", icon: FaCut, color: "text-purple-500", category: "Tools & Objects" },
