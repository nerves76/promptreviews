          ...
          <div className="flex items-center justify-between py-3 px-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="flex-shrink-0 w-7 h-7 flex items-center justify-center text-white/60 hover:text-white/90 transition-all duration-200 bg-white/10 hover:bg-white/20 rounded-full"
              >
