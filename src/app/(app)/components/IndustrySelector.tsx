...
const INDUSTRY_OPTIONS = [
  ...
  { label: "Carpet Cleaning", value: "Carpet Cleaning", type: "B2C" },
  { label: "Childcare & Parenting", value: "Childcare & Parenting", type: "B2C" },
  { label: "Chimney Services", value: "Chimney Services", type: "B2C" },
  { label: "Concrete & Masonry", value: "Concrete & Masonry", type: "B2C" },
  { label: "Credit Unions", value: "Credit Unions", type: "B2C" },
  { label: "Daycare Centers", value: "Daycare Centers", type: "B2C" },
  { label: "Deck & Patio Building", value: "Deck & Patio Building", type: "B2C" },
  { label: "Drywall & Plastering", value: "Drywall & Plastering", type: "B2C" },
  { label: "E-Commerce", value: "E-Commerce", type: "B2C" },
  { label: "Education & Tutoring", value: "Education & Tutoring", type: "B2C" },
  { label: "Electrician", value: "Electrician", type: "B2C" },
  { label: "Electronics & Appliances", value: "Electronics & Appliances", type: "B2C" },
  { label: "Fence Contractor", value: "Fence Contractor", type: "B2C" },
  { label: "Financial Services (B2C)", value: "Financial Services (B2C)", type: "B2C" },
  { label: "Fire & Water Damage Restoration", value: "Fire & Water Damage Restoration", type: "B2C" },
  { label: "Fitness & Gyms", value: "Fitness & Gyms", type: "B2C" },
  { label: "Flooring & Floor Refinishing", value: "Flooring & Floor Refinishing", type: "B2C" },
  { label: "Florists", value: "Florists", type: "B2C" },
  { label: "Garage Door Services", value: "Garage Door Services", type: "B2C" },
  { label: "General Contractor", value: "General Contractor", type: "B2C" },
  { label: "Gift Shops", value: "Gift Shops", type: "B2C" },
  { label: "Grocery & Supermarkets", value: "Grocery & Supermarkets", type: "B2C" },
  { label: "Gutter Services", value: "Gutter Services", type: "B2C" },
  { label: "Handyman Services", value: "Handyman Services", type: "B2C" },
  { label: "Health & Wellness", value: "Health & Wellness", type: "B2C" },
  { label: "Home Builder", value: "Home Builder", type: "B2C" },
  { label: "Home Cleaning", value: "Home Cleaning", type: "B2C" },
  { label: "Home Inspector", value: "Home Inspector", type: "B2C" },
  { label: "Hotels & Lodging", value: "Hotels & Lodging", type: "B2C" },
  { label: "HVAC (Heating & Air Conditioning)", value: "HVAC", type: "B2C" },
  { label: "Insulation Contractor", value: "Insulation Contractor", type: "B2C" },
  { label: "Jewelry & Accessories", value: "Jewelry & Accessories", type: "B2C" },
  { label: "Junk Removal", value: "Junk Removal", type: "B2C" },
  { label: "Kitchen Remodeling", value: "Kitchen Remodeling", type: "B2C" },
  { label: "Landscaping & Lawn Care", value: "Landscaping & Lawn Care", type: "B2C" },
  { label: "Locksmith", value: "Locksmith", type: "B2C" },
  ...
  { label: "Plumber", value: "Plumber", type: "B2C" },
  { label: "Pool & Hot Tub Services", value: "Pool & Hot Tub Services", type: "B2C" },
  { label: "Pressure Washing", value: "Pressure Washing", type: "B2C" },
  ...
  { label: "Roofer", value: "Roofer", type: "B2C" },
  { label: "Salons & Spas", value: "Salons & Spas", type: "B2C" },
  { label: "Septic System Services", value: "Septic System Services", type: "B2C" },
  { label: "Siding Contractor", value: "Siding Contractor", type: "B2C" },
  { label: "Solar Installation", value: "Solar Installation", type: "B2C" },
  ...
  { label: "Sprinkler System Services", value: "Sprinkler System Services", type: "B2C" },
  ...
  { label: "Tree Service & Arborist", value: "Tree Service & Arborist", type: "B2C" },
  { label: "Vacation Rentals", value: "Vacation Rentals", type: "B2C" },
  { label: "Veterinary Clinics", value: "Veterinary Clinics", type: "B2C" },
  { label: "Water Heater Services", value: "Water Heater Services", type: "B2C" },
  { label: "Wedding & Event Services", value: "Wedding & Event Services", type: "B2C" },
  { label: "Window Installation & Repair", value: "Window Installation & Repair", type: "B2C" },
