...
export default function RoleFieldFeature({
  ...
  return (
    <div className={`${editMode ? 'rounded-lg p-2 sm:p-4 bg-sky-50 border border-sky-200 flex flex-col gap-4 shadow relative mb-4' : 'bg-white rounded-lg border border-gray-200 p-6 mb-6'}`}>
