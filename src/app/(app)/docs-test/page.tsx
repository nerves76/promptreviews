    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="mt-8 p-4 bg-gray-100 rounded-lg">
        ...
        <ul className="space-y-1 text-sm">
          <li>
            <a href="/api/docs/articles/getting-started" className="text-blue-600 hover:underline">
              API: /api/docs/articles/getting-started
            </a>
          </li>
          <li>
            <a href="/api/docs/search?q=prompt" className="text-blue-600 hover:underline">
