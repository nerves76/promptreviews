  ...
  const handleGeneralSave = async (formState: any) => {
    ...
    try {
      ...
      const updateData = {
        ...
        fun_facts_enabled: formState.fun_facts_enabled ?? formState.funFactsEnabled ?? false,
        selected_fun_facts: formState.selected_fun_facts || formState.selectedFunFacts || null,
