...
import { TestFeedResponse } from "@/features/rss-feeds/types";
...
export default function TestFeedModal({ onClose, onUseUrl }: TestFeedModalProps) {
  ...
  return (
    <Modal isOpen={true} onClose={onClose} title="Test RSS feed" size="2xl">
      ...
      <div className="flex gap-2 mb-4">
        ...
        <button
          ...
          className="px-4 py-2 text-sm font-medium text-white bg-slate-blue rounded-lg hover:bg-slate-blue/90 transition-colors disabled:opacity-50 whitespace-nowrap"
        >
          {loading ? (
      ...
      {result?.success && (
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full px-4 py-2 text-sm font-medium text-white bg-slate-blue rounded-lg hover:bg-slate-blue/90 transition-colors whitespace-nowrap"
          >
            Use this feed
          </button>
        </div>
