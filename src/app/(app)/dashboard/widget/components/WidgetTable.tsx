                ...
                <td className="whitespace-nowrap px-3 py-4 text-sm">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-2.5 py-1.5 min-h-[36px] flex items-center gap-1.5 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors text-sm whitespace-nowrap"
                    ...
                    <button
                      ...
                      className="p-2 min-h-[36px] min-w-[36px] flex items-center justify-center text-red-600 hover:bg-red-50 rounded-lg transition-colors"
                      title="Delete widget"
