...
const StyleForm: React.FC<StyleFormProps> = ({ design, onDesignChange, onSave, onReset }) => {
  ...
  return (
    <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2 relative">
      {/* Card Appearance */}
      <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-100/50 rounded-xl space-y-4">
        <h3 className="text-sm font-semibold text-gray-800 border-b border-gray-200 pb-2">Card Appearance</h3>
      ...
      {/* Border Settings */}
      <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-100/50 rounded-xl space-y-4">
        <h3 className="text-sm font-semibold text-gray-800 border-b border-gray-200 pb-2">Border</h3>
      ...
      {/* Typography */}
      <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-100/50 rounded-xl space-y-4">
        <h3 className="text-sm font-semibold text-gray-800 border-b border-gray-200 pb-2">Typography</h3>
      ...
      {/* Shadow Effects */}
      <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-100/50 rounded-xl space-y-4">
        <h3 className="text-sm font-semibold text-gray-800 border-b border-gray-200 pb-2">Shadow Effects</h3>
      ...
      {/* Display Options */}
      <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-100/50 rounded-xl space-y-4">
        <h3 className="text-sm font-semibold text-gray-800 border-b border-gray-200 pb-2">Display Options</h3>
      ...
      {/* Animation Settings */}
      <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-100/50 rounded-xl space-y-4">
        <h3 className="text-sm font-semibold text-gray-800 border-b border-gray-200 pb-2">Animation</h3>
      ...
      <div className="p-4 bg-white/60 backdrop-blur-sm border border-gray-100/50 rounded-xl space-y-4">
        <h3 className="text-sm font-semibold text-gray-800 border-b border-gray-200 pb-2">Backdrop Blur</h3>
