              ...
              <table className="min-w-full">
                ...
                <thead>
                  <tr className="border-b border-white/20">
                    <th className="px-6 py-6 text-center align-top w-1/4">
                      <div className="flex flex-col items-center gap-3">
                        <div className="w-14 h-14 flex-shrink-0 rounded-2xl bg-gradient-to-br from-indigo-300/50 to-purple-400/50 flex items-center justify-center">
                        ...
                        <span className="text-base font-bold text-white text-center leading-tight">Features</span>
                      </div>
                    </th>
                    ...
                    <th className="px-4 py-6 text-center align-top bg-white/10 border-x border-white/10 min-w-[140px]">
                      <div className="relative group">
                        <div className="flex flex-col items-center gap-3 cursor-pointer">
                          ...
                          <span className="text-base font-bold text-white text-center leading-tight">Prompt Reviews</span>
                        </div>
                        {/* Hover card tooltip */}
                      ...
                      <tr className="border-b border-white/10">
                        ...
                        <td className="px-4 py-4 bg-white/5 border-x border-white/10">
                          <span className="text-sm text-white leading-relaxed">
                            Pricing tiers start at $20/month. $85/month for multi-location businesses.
                          </span>
                        </td>
                        {displayedCompetitors.map((comp) => (
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {feature.description && (
                                  <div className="relative group/tip">
                                    ...
                                    <div className="absolute left-6 top-1/2 -translate-y-1/2 w-64 opacity-0 invisible group-hover/tip:opacity-100 group-hover/tip:visible transition-all duration-200 z-50 pointer-events-none">
