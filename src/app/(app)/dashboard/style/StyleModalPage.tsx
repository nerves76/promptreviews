...
export default function StylePage({ onClose, onStyleUpdate, accountId: propAccountId }: StylePageProps) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Use the API endpoint for proper account isolation (apiClient handles auth headers)
      await apiClient.post('/businesses/update-style', updatePayload);
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div>
              ...
              >
                ...
                <option value="snazzy">Snazzy - Peachy-keen appreciation machine</option>
              </select>
            </div>
          </div>
