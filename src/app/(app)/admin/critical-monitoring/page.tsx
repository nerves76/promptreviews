    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-white/80">Loading monitoring dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-white">Critical function monitoring</h1>
              <p className="text-white/80 mt-1">Monitor your business-critical "Generate with AI" and "Copy & Submit" functionality</p>
            </div>
            <button
              onClick={loadData}
              disabled={refreshing}
