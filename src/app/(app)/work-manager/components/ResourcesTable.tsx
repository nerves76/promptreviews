        ...
        <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-white/30 w-64"
            />
          </div>
