...
const INDUSTRY_OPTIONS = [
  ...
  },
  {
    ...
    value: "Scientific & Technical Services",
    type: "B2B",
  },
  { label: "Energy & Utilities", value: "Energy & Utilities", type: "B2B" },
  {
    label: "Environmental Services (B2B)",
    value: "Environmental Services (B2B)",
    type: "B2B",
  },
  {
    label: "Agriculture & Farming (B2B)",
    value: "Agriculture & Farming (B2B)",
    type: "B2B",
  },
  ...
  { label: "Health & Wellness", value: "Health & Wellness", type: "B2C" },
  {
    ...
    value: "Medical & Dental Practices",
    type: "B2C",
  },
  {
  ...
  {
    label: "Test Prep & College Counseling",
    value: "Test Prep & College Counseling",
    type: "B2C",
  },
  ...
  {
    label: "Financial Services (B2C)",
    value: "Financial Services (B2C)",
    type: "B2C",
  },
  ...
  { label: "Property Management", value: "Property Management", type: "B2C" },
  {
    ...
    value: "Automotive Sales & Service",
    type: "B2C",
  },
  ...
  {
    label: "Transportation (Taxi, Rideshare, etc.)",
  ...
  {
    label: "Environmental Services (General)",
    value: "Environmental Services (General)",
    type: "Both",
  },
  {
