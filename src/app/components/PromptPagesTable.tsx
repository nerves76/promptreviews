                    ...
                    <button
                      ...
                      onClick={() =>
                        setQrModal({
                          ...
                          clientName: `${page.first_name || ""} ${page.last_name || ""}`.trim() || business?.name || "PromptReviews",
                        })
                      }
                    >
      ...
      {qrModal?.open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center relative">
            ...
            <QRCodeGenerator url={qrModal.url} clientName={qrModal.clientName} frameSize={selectedFrameSize} />
