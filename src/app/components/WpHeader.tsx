                  ...
                  <div className="ast-builder-layout-element ast-flex site-header-focus-item" data-section="title_tagline">
                    ...
                    >
                      <span className="site-logo-img">
                        <a href="https://promptreviews.app/" className="custom-logo-link" rel="home" aria-current="page">
                          <img
                            width="136"
                            height="49"
                      ...
                      <div className="ast-site-title-wrap">
                        <span className="site-title" itemProp="name">
                          <a href="https://promptreviews.app/" rel="home" itemProp="url">
                            {/* Site Title (if any) */}
                          </a>
                        </span>
                      </div>
                ...
                <div className="site-header-primary-section-right site-header-section ast-flex ast-grid-right-section">
                        ...
                        >
                          <div className="main-navigation ast-inline-flex">
                            <ul id="ast-hf-menu-1" className="main-header-menu ast-menu-shadow ast-nav-menu ast-flex  submenu-with-border stack-on-mobile">
                              <li id="menu-item-387" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-387">
                                <a href="https://promptreviews.app/about/" className="menu-link">About</a>
                              </li>
                              <li id="menu-item-386" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-386">
                                <a href="https://promptreviews.app/features-overview/" className="menu-link">Features</a>
                              </li>
                              <li id="menu-item-388" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-388">
                                <a href="https://promptreviews.app/pricing/" className="menu-link">Pricing</a>
                              </li>
                              <li id="menu-item-389" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-389">
                                <a href="https://promptreviews.app/contact/" className="menu-link">Contact</a>
                              </li>
                            </ul>
                          </div>
                        </nav>
                  ...
                  <div className="ast-builder-layout-element ast-flex site-header-focus-item ast-header-button-1" data-section="section-hb-button-1">
                    <div className="ast-builder-button-wrap ast-builder-button-size-default">
                      <a className="ast-custom-button-link" href="https://app.promptreviews.app/sign-up" target="_self" role="button" aria-label="Start free trial">
                        <div className="ast-custom-button">Start free trial</div>
                      </a>
                      <a className="menu-link" href="https://app.promptreviews.app/sign-up" target="_self">Start free trial</a>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  >
                    <div id="ast-hf-mobile-menu" className="main-navigation">
                      <ul className="main-header-menu ast-nav-menu ast-flex  submenu-with-border astra-menu-animation-fade  stack-on-mobile">
                        <li className="page_item page-item-20 menu-item"><a href="https://promptreviews.app/about/" className="menu-link">About</a></li>
                        <li className="page_item page-item-17 menu-item"><a href="https://promptreviews.app/contact/" className="menu-link">Contact</a></li>
                        <li className="page_item page-item-18 menu-item"><a href="https://promptreviews.app/faq/" className="menu-link">FAQ</a></li>
                        <li className="page_item page-item-366 menu-item"><a href="https://promptreviews.app/features-overview/" className="menu-link">Features</a></li>
                        <li className="page_item page-item-21 current-menu-item menu-item current-menu-item"><a href="https://promptreviews.app/" className="menu-link">Home</a></li>
                        <li className="page_item page-item-19 menu-item"><a href="https://promptreviews.app/pricing/" className="menu-link">Pricing</a></li>
                      </ul>
                    </div>
                  </nav>
                </div>
