...
Local development uses a **local Supabase database instance** via Docker. The production database is separate and only used in production deployments.
...
2. Sign in immediately (no email confirmation required on localhost)
