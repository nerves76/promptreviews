    ...
    <DocsLayout>
      ...
      <div className="max-w-4xl mx-auto mb-16">
        ...
        <p className="text-xl text-white/90 mb-8 text-balance">
          Connect your Google Business Profile to manage reviews, respond to customers, 
          create posts, and handle multiple locations—all from your Prompt Reviews dashboard.
        </p>
