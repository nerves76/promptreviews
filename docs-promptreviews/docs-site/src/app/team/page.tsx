    ...
    <DocsLayout>
      ...
      <div className="max-w-4xl mx-auto mb-16">
        ...
        <p className="text-xl text-white/90 mb-8 text-balance">
          Add team members, manage permissions, and control account settings. 
          Collaborate effectively while maintaining security and control.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://promptreviews.com/dashboard/team"
