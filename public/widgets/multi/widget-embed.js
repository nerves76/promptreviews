...
(function() {
  ...
  function createReviewCard(review, design) {
    ...
    const openingQuote = design.showQuotes ? `<span class="decorative-quote-opening" style="color: ${accentColor}; font-size: ${quoteSize}rem; font-weight: bold; line-height: 1; opacity: 0.2; position: absolute; top: 0; left: 0; pointer-events: none; transform: translateY(-50%);">"</span>` : '';
    const closingQuote = design.showQuotes ? `<span class="decorative-quote-closing" style="color: ${accentColor}; font-size: ${quoteSize}rem; font-weight: bold; line-height: 1; opacity: 0.2; position: absolute; bottom: 0; right: 0; pointer-events: none; transform: translateY(50%);">"</span>` : '';
