...
(function() {
  ...
  function renderMultiComparisonTable(data) {
    ...
    html += '</div>';
    // Hover card for Prompt Reviews description
    html += '<div class="pr-comparison-hover-card"><p>AI-powered review management platform that helps local businesses collect more 5-star reviews and build their online reputation.</p></div>';
    html += '</div></th>';
