...
SET DEFAULT '{business_name} needs your STAR POWER so more people can find them online!';

-- Update existing pages that still have the old default text
UPDATE prompt_pages 
SET motivational_nudge_text = '{business_name} needs your STAR POWER so more people can find them online!' 
