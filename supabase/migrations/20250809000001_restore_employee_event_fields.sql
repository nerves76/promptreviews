-- Restore employee and event specific fields to prompt_pages table
-- These were accidentally removed in 20250802134730_remote_schema.sql
-- Restoring them to fix EventPromptPageForm and EmployeePromptPageForm
