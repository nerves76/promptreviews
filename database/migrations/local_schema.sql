...
CREATE POLICY "Users can create businesses for their account" ON "public"."businesses" FOR INSERT WITH CHECK ((("account_id" IN ( SELECT "account_users"."account_id"
   FROM "public"."account_users"
  WHERE ("account_users"."user_id" = "auth"."uid"()))) OR ("account_id" = "auth"."uid"())));



CREATE POLICY "Users can delete their account's businesses" ON "public"."businesses" FOR DELETE USING ((("account_id" IN ( SELECT "account_users"."account_id"
   FROM "public"."account_users"
  WHERE ("account_users"."user_id" = "auth"."uid"()))) OR ("account_id" = "auth"."uid"())));
...
CREATE POLICY "Users can update their account's businesses" ON "public"."businesses" FOR UPDATE USING ((("account_id" IN ( SELECT "account_users"."account_id"
   FROM "public"."account_users"
  WHERE ("account_users"."user_id" = "auth"."uid"()))) OR ("account_id" = "auth"."uid"())));
...
CREATE POLICY "Users can view their account's businesses" ON "public"."businesses" FOR SELECT USING ((("account_id" IN ( SELECT "account_users"."account_id"
   FROM "public"."account_users"
  WHERE ("account_users"."user_id" = "auth"."uid"()))) OR ("account_id" = "auth"."uid"())));
