...
COMMENT ON COLUMN "public"."businesses"."ai_dos" IS 'AI-generated content preferences - what the business wants AI to do';



COMMENT ON COLUMN "public"."businesses"."ai_donts" IS 'AI-generated content preferences - what the business does not want AI to do';
...
COMMENT ON COLUMN "public"."businesses"."review_platforms" IS 'JSON object containing review platform configurations';
...
COMMENT ON COLUMN "public"."businesses"."keywords" IS 'SEO keywords for the business';
...
COMMENT ON COLUMN "public"."businesses"."services_offered" IS 'List of services offered by the business';
...
CREATE POLICY "Enable delete for users based on account_id" ON "public"."businesses" FOR DELETE USING (("auth"."uid"() IN ( SELECT "account_users"."user_id"
   FROM "public"."account_users"
  WHERE ("account_users"."account_id" = "businesses"."account_id"))));



CREATE POLICY "Enable insert for authenticated users" ON "public"."businesses" FOR INSERT WITH CHECK (("auth"."uid"() IN ( SELECT "account_users"."user_id"
   FROM "public"."account_users"
  WHERE ("account_users"."account_id" = "businesses"."account_id"))));



CREATE POLICY "Enable read access for authenticated users" ON "public"."businesses" FOR SELECT USING (("auth"."uid"() IN ( SELECT "account_users"."user_id"
   FROM "public"."account_users"
  WHERE ("account_users"."account_id" = "businesses"."account_id"))));



CREATE POLICY "Enable update for users based on account_id" ON "public"."businesses" FOR UPDATE USING (("auth"."uid"() IN ( SELECT "account_users"."user_id"
   FROM "public"."account_users"
  WHERE ("account_users"."account_id" = "businesses"."account_id"))));
...
CREATE POLICY "Users can create businesses for their account" ON "public"."businesses" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
...
CREATE POLICY "Users can update their account's businesses" ON "public"."businesses" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."account_users" "au"
  WHERE (("au"."account_id" = "businesses"."account_id") AND ("au"."user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view their account's businesses" ON "public"."businesses" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."account_users" "au"
  WHERE (("au"."account_id" = "businesses"."account_id") AND ("au"."user_id" = "auth"."uid"())))));
